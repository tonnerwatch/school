...
<div class="portlet-body">
    ...
    <?php
		...
		if (isset($general)) {
			...
			if ($validation_smis_id == FALSE || $validation_obec_id == FALSE || $validation_school_name_th == FALSE || $validation_school_name_en == FALSE || $validation_construct_at == FALSE || $validation_tel == FALSE || $validation_fax == FALSE || $validation_email == FALSE || $validation_dla == FALSE || $validation_type_education == FALSE || $validation_size_education == FALSE) {
				...
				$school .= "'" . $website . "',";
				$school .= "'" . $dla . "',";
				$school .= "'" . $type_education . "',";
				$school .= "'" . $size_education . "',";
				$school .= "'" . $electricity . "',";
				$school .= "'" . $school_area . "',";
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="smis_id" value="<?php echo $smis_id; ?>" maxlength="20" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="obec_id" value="<?php echo $obec_id; ?>" maxlength="20" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="school_name_th" value="<?php echo $school_name_th; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="school_name_en" value="<?php echo $school_name_en; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
    ...
    <div class="col-md-9">
    <div class="input-group date date-picker" data-date="<?php if(isset($general)){ echo $construct_at; } else { echo "12-02-2012"; } ?>" data-date-format="dd-mm-yyyy" data-date-viewmode="years">
    	<span class="input-group-btn">
    		<button class="btn default" type="button">
    			<i class="fa fa-calendar"></i>
    		</button>
    	</span>
    	<input name="construct_at" type="text" value="<?php echo $construct_at; ?>" class="form-control" readonly>
    </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="tel" value="<?php echo $tel; ?>" maxlength="10" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="fax" value="<?php echo $fax; ?>" maxlength="10" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="email" value="<?php echo $email; ?>" maxlength="50">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="website" value="<?php echo $website; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
	</div>
	</div>
    <div class="form-group form-md-line-input">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="dla" value="<?php echo $dla; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="type_education" value="<?php echo $type_education; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
    ...
    <div class="col-md-9">
		<select class="form-control" name="size_education">
			...
			<option value="S" <?php if($size_education == "S"){ echo "selected"; } ?>>S</option>
			<option value="M" <?php if($size_education == "M"){ echo "selected"; } ?>>M</option>
			<option value="L" <?php if($size_education == "L"){ echo "selected"; } ?>>L</option>
            <option value="XL" <?php if($size_education == "XL"){ echo "selected"; } ?>>XL</option>
		</select>
	<div class="form-control-focus"> </div>
    ...
    <div class="form-group">
		...
		<div class="md-radio">
			<input type="radio" id="checkbox1_6" name="electricity" value="มี" class="md-radiobtn" <?php if($electricity == "มี"){ echo "checked"; } ?>>
		...
		<div class="md-radio">
			<input type="radio" id="checkbox1_7" name="electricity" value="ไม่มี" class="md-radiobtn" <?php if($electricity == "มี"){ echo ""; } else { echo "checked"; } ?>>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="school_area" value="<?php echo $school_area; ?>" maxlength="3" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	</div>
	</div>
    <div class="form-group form-md-line-input">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="school_district" value="<?php echo $school_area; ?>" maxlength="3" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	</div>
	</div>
    <div class="form-group form-md-line-input">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="lititude" value="<?php echo $lititude; ?>" maxlength="20" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	</div>
	</div>
    <div class="form-group form-md-line-input">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="longtitude" value="<?php echo $longtitude; ?>" maxlength="20" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	</div>
	</div>
    <div class="form-group form-md-line-input">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="amount_book" value="<?php echo $amount_book; ?>" maxlength="10" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	</div>
	</div>
...
<div class="portlet-body">
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="home_code" value="<?php echo $home_code; ?>" maxlength="20">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="moo" value="<?php echo $moo; ?>" maxlength="3" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="road" value="<?php echo $road; ?>" maxlength="50">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="soy" value="<?php echo $soy; ?>">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="district" value="<?php echo $district; ?>" maxlength="100">
	<div class="form-control-focus"> </div>
	...
	<div class="col-md-9">
		<input type="text" class="form-control maxlength_defaultconfig" placeholder="" name="zip_code" value="<?php echo $zip_code; ?>" maxlength="5" OnKeyPress="return chkNumber(this)">
	<div class="form-control-focus"> </div>
