...
<head>
<meta charset="utf-8">
<title>เกรดเฉลี่ยห้อง <?php echo $_SESSION['class'] . "/" . $_SESSION['room']; ?></title>
...
<page size="A4">
  ...
  <div align="center"><?php echo $data['school_name_th']; ?></div>
    <div style="text-align:center;margin-bottom: 30px;"><b>รายงานเกรดเฉลี่ยของ
      <label><?php echo " " . $_SESSION['class'] . "/" . $_SESSION['room'];
	  ?></label>
      </b></div>
    ...
    <?php
				include('mysql_connect.php');
				$sql1 = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id]";
    ...
    <table style="border-collapse: collapse;" border="1" align="center">
      ...
      <tr>
        ...
        <td align="center" id="a"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 0 and $term <= 1.00";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 1.01 and $term <= 1.50";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 1.51 and $term <= 2.00";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 2.01 and $term <= 2.50";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 2.51 and $term <= 3.00";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 3.01 and $term <= 3.50";
						$result = mysqli_query($link, $sql);
      ...
      <tr>
        ...
        <td align="center"><?php 
						...
						$sql = "SELECT * FROM student WHERE class = '$_SESSION[class]' and room = '$_SESSION[room]' and school_id = $_SESSION[school_id] and year = '$_POST[year]' and $term >= 3.51 and $term <= 4.00";
						$result = mysqli_query($link, $sql);
