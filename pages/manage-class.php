...
<div class="caption font-dark"> <i class="icon-settings font-dark"></i> <span class="caption-subject bold uppercase"> รายงานห้อง <?php echo $id; ?></span> </div>
<div class="actions">
</div>
</div>
<div class="page-head">
...
<a class='dashboard-stat dashboard-stat-v2 blue' href='#GRADE' role='button' data-toggle='modal'>
<div class='visual'>
...
<div class='desc'> <?php echo $id; ?> </div>
</div>
</a>
<!-- O-NET -->
...
<form action="grade-of-class.php" method="post" class="form-horizontal form-row-seperated" target="_blank">
...
<!-- END O-NET -->
<?php
	if($id == "ป.6" || $id == "ม.3" || $id == "ม.6"){
		echo "<a class='dashboard-stat dashboard-stat-v2 red' href='#myModal_autocomplete' role='button' data-toggle='modal'>";
		echo "<div class='visual'>";
		echo "<i class='fa fa-bar-chart-o'></i>";
		echo "</div>";
		echo "<div class='details'>";
		echo "<div class='number'>";
		echo "<span data-counter='counterup' data-value='12,5'>O-NET</span> </div>";
		echo "<div class='desc'>$id </div>";
		echo "</div>";
		echo "</a>";
    }
?>
...
<div class="modal-body form">
<form action="onet-of-class.php?id=<?php echo $id; ?>" method="post" class="form-horizontal form-row-seperated" target="_blank">
<div class="form-group">
...
<div class="modal-body form">
<form action="disabled-of-class.php?id=<?php echo $id; ?>" method="post" class="form-horizontal form-row-seperated" target="_blank">
<div class="form-group">
<label class="col-sm-4 control-label">กรอกปีการศึกษา</label>
<div class="col-sm-8">
<div class="input-group">
...
<div class="modal-body form">
<form action="lack-of-class.php?id=<?php echo $id; ?>" method="post" class="form-horizontal form-row-seperated" target="_blank">
<div class="form-group">
<label class="col-sm-4 control-label">กรอกปีการศึกษา</label>
<div class="col-sm-8">
<div class="input-group">
...
<div class="modal-body form">
<form action="op-of-class.php?id=<?php echo $id; ?>" method="post" class="form-horizontal form-row-seperated" target="_blank">
<div class="form-group">
<label class="col-sm-4 control-label">กรอกปีการศึกษา</label>
<div class="col-sm-8">
<div class="input-group">
