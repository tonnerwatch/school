...
<head>
<meta charset="utf-8" />
<title>ภาพรวมผู้พิการของห้อง <?php echo $_SESSION['class'] . "/" . $_SESSION['room'] . " ปี " . $year; ?></title>
...
<span class="caption-subject font-dark bold uppercase">กราฟแสดงภาพรวมผู้พิการของห้อง <?php echo $_SESSION['class'] . "/" . $_SESSION['room'] . " โรงเรียน" . $data['school_name_th'] . " ปี " . $year; ?></span>
</div>
</div>
    ...
    <table class="table-bordered table-hover" style="margin: 50px auto 50px auto;">
    	...
    	<tr>
            ...
            <td>จำนวนนักเรียนที่พิการ</td>
    	</tr>
        </thead>
        <tbody style="text-align: center;">
        <?php
		$sql = "SELECT COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and room = '" . $_SESSION['room'] . "'";
		$result = mysqli_query($link, $sql);
		$data = mysqli_fetch_assoc($result);
		...
		$sql = "SELECT COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and room = '" . $_SESSION['room'] . "' and (d1 = '1' or d2 = '1' or d3 = '1' or d4 = '1' or d5 = '1' or d6 = '1' or d7 = '1' or d8 = '1' or d9 = '1')";
		$result = mysqli_query($link, $sql);
		$data = mysqli_fetch_assoc($result);
    ...
    <?php
    $sql = "SELECT SUM(d1) AS D1, SUM(D2) AS D2, SUM(d3) AS D3, SUM(d4) AS D4, SUM(d5) AS D5, SUM(d6) AS D6, SUM(d7) AS D7, SUM(d8) AS D8, SUM(d9) AS D9, COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and room = '" . $_SESSION['room'] . "' and year = '" . $year . "'";
    $result = mysqli_query($link, $sql);
    $disabled = mysqli_fetch_assoc($result);
    ...
    $d1_persen = @(($d1 / $SumD) * 100);
    $d2_persen = @(($d2 / $SumD) * 100);
    $d3_persen = @(($d3 / $SumD) * 100);
    $d4_persen = @(($d4 / $SumD) * 100);
    $d5_persen = @(($d5 / $SumD) * 100);
    $d6_persen = @(($d6 / $SumD) * 100);
    $d7_persen = @(($d7 / $SumD) * 100);
    $d8_persen = @(($d8 / $SumD) * 100);
    $d9_persen = @(($d9 / $SumD) * 100);
    ?>
...
<th width="55%" class="center">ความพิการ</th>
<th width="20%" class="center">จำนวนความพิการทั้งหมด</th>
...
<tr>
    ...
    <td> ความพิการทางการมองเห็น </td>
<td width="50" class="center"> <?php echo $d1; ?> </td>
<td width="50" class="center"> <?php echo number_format($d1_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D2 </td>
<td> ความพิการทางการได้ยิน </td>
<td width="50" class="center"> <?php echo $d2; ?> </td>
<td width="50" class="center"> <?php echo number_format($d2_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D3 </td>
<td> ความพิการทางสติปัญญา </td>
<td class="center"> <?php echo $d3; ?> </td>
<td width="50" class="center"> <?php echo number_format($d3_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D4 </td>
<td width="50"> ความพิการทางร่างกายและสุขภาพ </td>
<td class="center"> <?php echo $d4; ?> </td>
<td width="50" class="center"> <?php echo number_format($d4_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D5 </td>
<td width="50"> ความพิการทางการเรียนรู้ </td>
<td class="center"> <?php echo $d5; ?> </td>
<td width="50" class="center"> <?php echo number_format($d5_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D6 </td>
<td width="50"> ความพิการทางพูดและภาษา </td>
<td class="center"> <?php echo $d6; ?> </td>
<td width="50" class="center"> <?php echo number_format($d6_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D7 </td>
<td width="50"> ความพิการทางพฤติกรรมและอารมณ์ </td>
<td class="center"> <?php echo $d7; ?> </td>
<td width="50" class="center"> <?php echo number_format($d7_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D8 </td>
<td width="50"> ความพิการทางออทิสติก </td>
<td class="center"> <?php echo $d8; ?> </td>
<td width="50" class="center"> <?php echo number_format($d8_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
<tr>
    <td class="center"> D9 </td>
<td width="50"> ความพิการทางการซ้ำซ้อน </td>
<td class="center"> <?php echo $d9; ?> </td>
<td width="50" class="center"> <?php echo number_format($d9_persen, 2, '.', ' ') . "%"; ?> </td>
</tr>
</tbody>
<tfoot>
<td class="center" colspan="2">รวม</td>
<td class="center"><?php echo $d1 + $d2 + $d3 + $d4 + $d5 + $d6 + $d7 + $d8 + $d9;?></td>
<td class="center"><?php echo number_format($d1_persen + $d2_persen + $d3_persen + $d4_persen + $d5_persen + $d6_persen + $d7_persen + $d8_persen + $d9_persen, 2, '.', ' ') . "%"; ?></td>
</tfoot>
</table>
<!-- BEGIN CHART PORTLET-->
<div class="light">
