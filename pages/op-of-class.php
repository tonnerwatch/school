...
<head>
<meta charset="utf-8" />
<title>ภาพรวมผู้ด้อยโอกาสของห้อง <?php echo $id . " ปี " . $year; ?></title>
...
<span class="caption-subject font-dark bold uppercase">กราฟแสดงภาพรวมผู้ด้อยโอกาสของห้อง <?php echo $id . " โรงเรียน" . $data['school_name_th'] . " ปี " . $year; ?></span>
</div>
</div>
    ...
    <table class="table-bordered table-hover" style="margin: 50px auto 50px auto;">
		...
		$sql = "SELECT COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and (i1 or i2 or i3 or i4 or i5 or i6 or i7 or i8 or i9 or i10 or i11 or i12 or i13) = '1'";
		$result = mysqli_query($link, $sql);
		$data = mysqli_fetch_assoc($result);
    ...
    <table width="40%" class="table-bordered table-hover" style="margin: 0 auto;">
        ...
        <tr>
            ...
            <td width="20%" style="text-align: center;" width="50">จำนวนนักเรียน</td>
        ...
        <tr><table width="40%" class="table-bordered table-hover" style="margin: 0 auto;">
                <thead style="background-color: deepskyblue;">
                <tr>
