...
<head>
<meta charset="utf-8" />
<title>เกรดเฉลี่ยโดยรวมของชั้น <?php echo $_SESSION['class']; ?></title>
...
<span class="caption-subject font-dark bold uppercase">กราฟแสดงข้อมูลเกรดเฉลี่ยภาพรวมของชั้น <?php echo $_SESSION['class'] . " โรงเรียน" . $data['school_name_th'] . " เทอมที่ " . $Term . " ปีการศึกษา " . $Year; ?></span>
</div>
</div>
<table width="52%" class="table table-bordered table-hover" style="margin: 0 auto;">
<thead>
<tr>
<th style="text-align: center;" width="200"> ช่วงเกรดเฉลี่ย </th>
<th style="text-align: center;" width="50"> จำนวนนักเรียน </th>
<th style="text-align: center;" width="50"> คิดเป็นเปอร์เซ็น(%) </th>
</tr>
</thead>
<tbody>
<tr>
...
<?php
	$sql = "SELECT year AS YEAR FROM grade WHERE school_id = '" . $_SESSION['school_id'] . "' and year = '$Year'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$Year = $data['YEAR'];
	
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and average.term = '$Term' and average.year = '$Year' and average.average >= 0 and average.average <= 1 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT1 = $data['AVERAGE'];
?>
...
<?php
	$sql = "SELECT COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$Student = $data['STUDENT'];
	
	$Average1 = number_format(@(($COUNT1 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average1 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 1.01 - 1.50</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 1.01 and average <= 1.50 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT2 = $data['AVERAGE'];
?>
...
<?php
	$Average2 = number_format(@(($COUNT2 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average2 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 1.51 - 2.00</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 1.51 and average <= 2.00 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT3 = $data['AVERAGE'];
?>
...
<?php
	$Average3 = number_format(@(($COUNT3 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average3 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 2.01 - 2.50</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 2.01 and average <= 2.50 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT4 = $data['AVERAGE'];
?>
...
<?php
	$Average4 = number_format(@(($COUNT4 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average4 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 2.51 - 3.00</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 2.51 and average <= 3.00 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT5 = $data['AVERAGE'];
?>
...
<?php
	$Average5 = number_format(@(($COUNT5 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average5 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 3.01 - 3.50</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 3.01 and average <= 3.50 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT6 = $data['AVERAGE'];
?>
...
<?php
	$Average6 = number_format(@(($COUNT6 / $Student) * 100), 2, '.', ' ');
?>
<td style="text-align: center;"> <?php echo $Average6 . "%"; ?> </td>
</tr>
<tr>
<td style="text-align: center;"> 3.51 - 4.00</td>
<?php
	$sql = "SELECT COUNT(average.average) AS AVERAGE FROM average inner join student on average.id_card = student.id_card WHERE average.school_id = '" . $_SESSION['school_id'] . "' and term = '$Term' and average.year = '$Year' and average >= 3.51 and average <= 4.00 and student.class = '" . $_SESSION['class'] . "'";
	$result = mysqli_query($link, $sql);
	$data = mysqli_fetch_assoc($result);
	$COUNT7 = $data['AVERAGE'];
?>
...
<?php
	$Average7 = number_format(@(($COUNT7 / $Student) * 100), 2, '.', ' ');
?>
...
<?php
$Average = $Average1 + $Average2 + $Average3 + $Average4 + $Average5 + $Average6 + $Average7;
?> 
</td>
