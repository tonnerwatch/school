      ...
      <div class="row">
        <div class="col-md-12">
          <div class="portlet light portlet-fit ">
            ...
            <form method="post" action="report3.php" target="_blank">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control input-circle" name="term" maxlength="1" min="1" max="3" placeholder="ภาคเรียนที่" required>
              </div>
