        ...
        <div class="col-md-12">
          <div class="portlet light portlet-fit ">
            <div class="portlet-title">
              <div class="caption"> <i class="icon-wrench font-green-meadow"></i> <span class="caption-subject font-green-meadow sbold uppercase"> ความพิการ </span> </div>
              <div class="actions"> <a class="btn btn-circle btn-icon-only btn-default fullscreen" href="javascript:;"> </a> </div>
            </div>
            <div class="portlet-body">
            <form method="post" action="grahp-disabled.php" target="_blank">
