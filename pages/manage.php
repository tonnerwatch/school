          ...
          <div class="portlet light portlet-fit ">
            ...
            <form method="post">
			  ...
			  if(isset($_POST['insert'])){
				  ...
				  if($_POST['aa'] == "d"){
					 header('refresh: 1;url = report-disabled-header.php'); 
				  } else if($_POST['aa'] == "l"){
					 header('refresh: 1;url = report-lack-header.php'); 
				  } else if($_POST['aa'] == "i"){
					  header('refresh: 1;url = report-opportunities-header.php');
				  }
			  }
			  ?>
            </div>
