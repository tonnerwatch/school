...
<head>
<meta charset="utf-8" />
<title>ภาพรวมผู้ด้อยโอกาสของห้อง <?php echo $_SESSION['class'] . "/" . $_SESSION['room'] . " ปี " . $year; ?></title>
...
<span class="caption-subject font-dark bold uppercase">กราฟแสดงภาพรวมผู้ด้อยโอกาสของห้อง <?php echo $_SESSION['class'] . "/" . $_SESSION['room'] . " โรงเรียน" . $data['school_name_th'] . " ปี " . $year; ?></span>
</div>
</div>
    ...
    <table class="table-bordered table-hover" style="margin: 50px auto 50px auto;">
		...
		$sql = "SELECT COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and room = '" . $_SESSION['room'] . "' and (i1 or i2 or i3 or i4 or i5 or i6 or i7 or i8 or i9 or i10 or i11 or i12 or i13) = '1'";
		$result = mysqli_query($link, $sql);
		$data = mysqli_fetch_assoc($result);
    ...
    <?php
    $sql = "SELECT SUM(i1) AS I1, SUM(i2) AS I2, SUM(i3) AS I3, SUM(i4) AS I4, SUM(i5) AS I5, SUM(i6) AS I6, SUM(i7) AS I7, SUM(i8) AS I8, SUM(i9) AS I9, SUM(i10) AS I10, SUM(i11) AS I11, SUM(i12) AS I12, SUM(i13) AS I13, COUNT(student_id) AS STUDENT FROM student WHERE school_id = '" . $_SESSION['school_id'] . "' and class = '" . $_SESSION['class'] . "' and room = '" . $_SESSION['room'] . "' and year = '" . $year . "'";
    $result = mysqli_query($link, $sql);
