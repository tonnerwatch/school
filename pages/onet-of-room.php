...
<head>
<meta charset="utf-8" />
<title>ผลการทดสอบทางการศึกษาระดับชาติขึ้นพื้นฐาน ชั้น <?php echo $_SESSION['class'] . "/" . $_SESSION['room']; ?></title>
...
<span class="caption-subject font-dark bold uppercase">กราฟแสดงผลการทดสอบทางการศึกษาระดับชาติขั้นพื้นฐาน <?php echo $_SESSION['class'] . "/" . $_SESSION['room'] . " โรงเรียน" . $data['school_name_th']; ?></span>
</div>
</div>
...
<?php
	...
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'ภาษาไทย'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
	$thai_language = @($score['SCORE'] / $score['CLASS']);
	
	
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'คณิตศาสตร์'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
	$math = @($score['SCORE'] / $score['CLASS']);
	
	
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'วิทยาศาสตร์'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
	$science = @($score['SCORE'] / $score['CLASS']);
	
	
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'ศิลปะ'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
	$art = @($score['SCORE'] / $score['CLASS']);
	
	
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'การงานอาชีพและเทคโนโลยี'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
	...
	$sql = "SELECT SUM(onet.max_score) AS MAX, COUNT(onet.class) AS CLASS, SUM(onet.score) AS SCORE FROM onet inner join student on onet.id_card = student.id_card WHERE student.school_id = '" . $_SESSION['school_id'] . "' and student.class = '" . $_SESSION['class'] . "' and student.room = '" . $_SESSION['room'] . "' and onet.year = '" . $year . "' and subject = 'ภาษาอังกฤษ'";
	$result = mysqli_query($link, $sql);
	$score = mysqli_fetch_assoc($result);
